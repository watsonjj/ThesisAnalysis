...
copy("charge_resolution/6_tf_comparison/gen/charge_res_wrr.pdf", "a4", "cr_6_tf_comparison.pdf")
copy("charge_resolution/6_tf_comparison/cells/charge_res_wrr.pdf", "a4", "cr_6_tf_comparison_cells.pdf")
...
copy("hillas/checm/bright_time_cropped.pdf", "ch6", "checm_time_image.pdf")
copy("hillas/checm/bright_cropped.pdf", "ch6", "checm_charge_image.pdf")
